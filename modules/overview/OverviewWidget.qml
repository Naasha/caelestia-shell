...
Item {
    ...
    property color activeBorderColor: "blue" // TODO-nasha  : replace with Colors Appearance.colors.colSecondary
    ...
    implicitWidth: overviewBackground.implicitWidth + 10 * 2 // TODO-nasha  Appearance.sizes.elevationMargin * 2
    implicitHeight: overviewBackground.implicitHeight + 10 * 2 // TODO-nasha  Appearance.sizes.elevationMargin * 2
    ...
    Rectangle { // Background
        ...
        anchors.fill: parent
        anchors.margins: 10 // TODO-nasha  Appearance.sizes.elevationMargin

        implicitWidth: workspaceColumnLayout.implicitWidth + padding * 2
        implicitHeight: workspaceColumnLayout.implicitHeight + padding * 2
        radius: 23 // TODO-nasha  Appearance.rounding.screenRounding * root.scale + padding
        // color: Appearance.colors.colLayer0
        color: "pink"
        border.width: 1
        border.color: "purple" // TODO-nasha  Appearance.m3colors.m3outlineVariant
                ...
                delegate: RowLayout {
                    ...
                    Repeater {
                        ...
                        Rectangle { // Workspace
                            ...
                            property color defaultWorkspaceColor: "Green" // TODO-nasha Appearance.colors.colLayer1 // TODO: reconsider this color for a cleaner look
                            property color hoveredWorkspaceColor: Colours.mix(defaultWorkspaceColor, "Red", 0.1) // TODO-nasha Appearance.colors.colLayer1Hover
                            property color hoveredBorderColor: "Yellow" // TODO-nasha Appearance.colors.colLayer2Hover
                            property bool hoveredWhileDragging: false

                            implicitWidth: root.workspaceImplicitWidth
                            implicitHeight: root.workspaceImplicitHeight
                            color: hoveredWhileDragging ? hoveredWorkspaceColor : defaultWorkspaceColor
                            radius: 23 * root.scale // TODO-nasha Appearance.rounding.screenRounding * root.scale
                            border.width: 2
                            ...
                            StyledText {
                                ...
                                color: ColourUtils.transparentize("white", 0.8) // TODO-nasha ColorUtils.transparentize(Appearance.colors.colOnLayer1, 0.8)
        ...
        Item { // Windows & focused workspace indicator
            ...
            Rectangle { // Focused workspace indicator
                ...
                //TODO-nasha  : remplacer l'animation
                // Behavior on x {
